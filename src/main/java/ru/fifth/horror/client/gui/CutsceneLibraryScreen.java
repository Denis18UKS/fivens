...
/** Responsive cutscene library; VHS recording is opened through the editor so a real frame recording is created. */
public final class CutsceneLibraryScreen extends HorrorScreen {
    ...
    private void cassette(){if(selected.isBlank())return;edit();status="Открываю сцену — нажми «Записать VHS».";}
